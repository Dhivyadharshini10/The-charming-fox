...
$(document).ready(function () {
  ...
  $('.product img').hover(function (e) {
    // Create zoomed image on hover
    const zoomedImage = $('<div class="zoomed-image"></div>');
    ...
    $(this).on('mousemove', function (e) {
      ...
      const posX = (offsetX / imgWidth) * 100;
      const posY = (offsetY / imgHeight) * 100;
    ...
    // Remove zoomed image when mouse leaves
    $('.zoomed-image').remove();
  });
